defmodule BookmarkWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule BookmarkWeb.PageLive do
        use BookmarkWeb, :live_view

        on_mount {BookmarkWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BookmarkWeb.UserAuth, :ensure_authenticated}] do
