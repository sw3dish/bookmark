defmodule BookmarkWeb.UserRegistrationLive do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      ...
      >
        ...
        <%= if @check_errors && Keyword.get(@form.errors, :registration_token) do %>
          <.error>
            <%= elem(Keyword.get(@form.errors, :registration_token), 0) %>
          </.error>
        <% end %>
